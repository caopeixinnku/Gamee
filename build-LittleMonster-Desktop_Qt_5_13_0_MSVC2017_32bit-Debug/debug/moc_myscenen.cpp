/****************************************************************************
** Meta object code from reading C++ file 'myscenen.h'
**
...
#include <memory>
#include "../../LittleMonster/myscenen.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'myscenen.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 12), // "signal_space"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "mShrink"

    },
    "MyScene\0signal_space\0\0mShrink"
};
...
void MyScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signal_space(); break;
        case 1: _t->mShrink(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyScene::signal_space)) {
                *result = 0;
                return;
            }
        }
