...
#include <memory>
#include "../../LittleMonster/handler.h"
...
QT_MOC_LITERAL(1, 8, 11), // "eatfoodorai"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "handler\0eatfoodorai\0"
};
...
void handler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&handler::eatfoodorai)) {
                *result = 0;
                return;
            }
        }
